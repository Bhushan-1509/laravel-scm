                                            ...
                                            <td style="min-width: 170px;">
                                                ...
                                                <form action="{{ route('pos.updateCartItem', $item->rowId) }}" method="POST">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="number" class="form-control" name="qty" required value="{{ old('qty', $item->quantity) }}">
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    <form action="{{ route('pos.addCartItem', $product) }}" method="POST">
                                                        ...
                                                        <input type="hidden" name="selling_price" value="{{ $product->quantity }}">
